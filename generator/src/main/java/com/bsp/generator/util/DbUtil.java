package com.bsp.generator.util;

//import com.bsp.generator.enums.EnumGenerator;
...
public class DbUtil {
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            String url = "jdbc:mysql://localhost:3306/bsp?serverTimezone=Asia/Shanghai";
            String user = "root";
            String pass = "lskreno";
...
////                    field.setEnums(true);
////
////                    // 例：从注释中的“枚举[UserLevel]”，得到USER_LEVEL
...
////                }
     ...
     * @throws Exception
     */
    public static String getPrimaryColumnByTableName(String tableName) throws Exception {
        ...
        if (rs.next()) {
            ...
            return lineToBigHump(stringArr[0]);
        }
        rs.close();
        pre.close();
        conn.close();
