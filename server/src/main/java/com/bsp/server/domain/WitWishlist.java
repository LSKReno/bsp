...
public class WitWishlist {
    ...
    public boolean equals(Object that) {
        ...
        WitWishlist other = (WitWishlist) that;
        return (this.getWitId() == null ? other.getWitId() == null : this.getWitId().equals(other.getWitId()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getWitId() == null) ? 0 : getWitId().hashCode());
    ...
    public enum Column {
        witId("WIT_ID", "witId", "INTEGER", false),
