...
public class SpvSpecificAttributeValue {
    ...
    public boolean equals(Object that) {
        ...
        SpvSpecificAttributeValue other = (SpvSpecificAttributeValue) that;
        return (this.getSpvId() == null ? other.getSpvId() == null : this.getSpvId().equals(other.getSpvId()))
            && (this.getSpaId() == null ? other.getSpaId() == null : this.getSpaId().equals(other.getSpaId()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getSpvId() == null) ? 0 : getSpvId().hashCode());
    ...
    public enum Column {
        spvId("SPV_ID", "spvId", "INTEGER", false),
