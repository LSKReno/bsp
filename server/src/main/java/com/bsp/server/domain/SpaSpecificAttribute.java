...
public class SpaSpecificAttribute {
    ...
    public boolean equals(Object that) {
        ...
        SpaSpecificAttribute other = (SpaSpecificAttribute) that;
        return (this.getSpaId() == null ? other.getSpaId() == null : this.getSpaId().equals(other.getSpaId()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getSpaId() == null) ? 0 : getSpaId().hashCode());
    ...
    public enum Column {
        spaId("SPA_ID", "spaId", "INTEGER", false),
