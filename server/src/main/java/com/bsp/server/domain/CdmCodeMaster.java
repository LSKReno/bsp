...
public class CdmCodeMaster {
    ...
    public boolean equals(Object that) {
        ...
        CdmCodeMaster other = (CdmCodeMaster) that;
        return (this.getCdmId() == null ? other.getCdmId() == null : this.getCdmId().equals(other.getCdmId()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getCdmId() == null) ? 0 : getCdmId().hashCode());
